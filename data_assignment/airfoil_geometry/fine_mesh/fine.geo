...
//  ## Cushion variables ## //
cushion_width = 0.30;
cushion_LE_len = 0.02; //must be greater than 0!
...
Point(649) = {-cushion_LE_len, cushion_width*0.7, 0, 1.0};
//+
Point(650) = {-cushion_LE_len, -cushion_width*0.7, 0, 1.0};
...
//+
//+
Split Curve {1} Point {266, 198, 426,47};
//+
...
Line(218) = {47, 683};
//+
Point(725) = {0.89, -cushion_width * 0.7, 0, 1.0};
//+
Line(219) = {506, 725};
//+
...
Transfinite Curve{124,43,91} = cushion_points/4 Using Progression 1;
